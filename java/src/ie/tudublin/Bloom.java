...
public class Bloom extends Poly{
    ...
    public void render() {
        ...
        //v.colorMode(PApplet.RGB); //looks better for envisioned result
        v.background(0);
        //v.strokeWeight(5); //different thicknesses of rect produce different resulting flower-esque patterns
        v.noStroke();
        ...
        for(int i = 0; i < 400; i++){ //400 is number of squares on screen at any moment
            ...
            float c = PApplet.map(i,0, v.getAudioBuffer().size() , -1, cRange);
            v.fill((c2/2)+50,c+50,c+10);//allows for darker edges of the flower creating an almost 3d shape
